                    ...
                    <li>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="<?=Url::to(['/admins/update','id' => Yii::$app->user->id])?>"><i class="fa fa-user"></i> 个人中心</a></li>
...
<div class="leftpanel">
    ...
    <div class="media leftpanel-profile">
        <div class="media-left">
            <a href="<?=Url::to(['/admins/update','id' => Yii::$app->user->id])?>">
    ...
    <div class="leftpanel-userinfo collapse" id="loguserinfo">
        ...
        <address><?=Yii::$app->user->identity->addres?></address>
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                ...
                <span class="pull-right"><?=Yii::$app->user->identity->iphone?></span>
            </li>
            <li class="list-group-item">
