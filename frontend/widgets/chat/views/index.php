...
<div class="panel-body">
    <form action="/" id="w0" method="post">
        ...
        <input type="hidden" value="<?php echo \Yii::$app->request->csrfToken; ?>" id="csrf" name="_csrf" >
...
<?php if (!empty($data['feed'])):?>
    <ul class="media-list media-feed feed-index ps-container ps-active-y">
        ...
        <li class="media">
            ...
            <img alt="" class="avatar-img" style="width:37px;height:37px;" src="<?= $list['user']['username']?>"/></a></div>
